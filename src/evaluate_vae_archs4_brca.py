...
for drop in d_rates:
	for drop2 in d_rates2:
		...
		output_filename="../results/VAE/{}_hidden_{}_emb/archs4_classifier_dropout_{}_in_{}_hidden_rec_loss_{}_classifier_frozen_{}_cv.csv".format(hidden_dim, latent_dim, dropout_input, dropout_hidden, reconstruction_loss, freeze_weights)
