...
d_rates3 = [0.5]
d_rates4 = [0.2]
for drop1 in d_rates3:
	for drop2 in d_rates4:
		...
		output_filename="../results/fully_con/{}_hidden_{}_emb_tcga_classifier_dropout_{}_in_{}_hidden_cv_raw_tcga.csv".format(hidden_dim_1, hidden_dim_2, dropout_input, dropout_hidden)
